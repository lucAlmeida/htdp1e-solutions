...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname ex14.1.5) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #f)))
...
;; eye-colors : ftn -> boolean
;; produce list of all eyes colors in the list
